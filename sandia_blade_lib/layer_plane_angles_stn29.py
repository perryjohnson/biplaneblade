...
IS3_triax_uAP1_tri_elem_num = 3551  # num of tri elem in IS3 triax upper aft panel 1
IS3_triax_lAP1_tri_elem_num = 3469  # num of tri elem in IS3 triax lower aft panel 1
IS3_resin_u2_tri_elem_num = 3098  # num of tri elem in IS3 resin upper 2
IS3_resin_l2_tri_elem_num = 3016  # num of tri elem in IS3 resin lower 2
IS3_triax_u2_tri_elem_num = 3409  # num of tri elem in IS3 triax upper 2
IS3_triax_l2_tri_elem_num = 3324  # num of tri elem in IS3 triax lower 2
TEr_foam_u2_tri_elem_num = 3902  # num of tri elem in TE reinf foam upper 2
TEr_foam_l2_tri_elem_num = 3716  # num of tri elem in TE reinf foam lower 2
TEr_foam_u3_tri_elem_num  = 3912  # num of tri elem in TE reinf foam upper 3
TEr_foam_l3_tri_elem_num  = 3732  # num of tri elem in TE reinf foam lower 3
TEr_uniax_u3_tri_elem_num = 4114  # num of tri elem in TE reinf uniax upper 3
TEr_uniax_l3_tri_elem_num = 4013  # num of tri elem in TE reinf uniax lower 3
# -----------------------------------------------
...
# alternate element sets of triangular elements on the lower surface
# outer_edge_node_nums=[3,1]
list_of_tri_lower2_elementsets = [
    'tefoaml2_tri'
]

# alternate element sets of triangular elements on the upper surface
# outer_edge_node_nums=[2,3]
list_of_tri_upper2_elementsets = [
    'tefoamu2_tri'
]
...
g.list_of_elements[IS3_triax_uAP1_tri_elem_num-1].element_set = 'is3tuap1_tri'
g.list_of_elements[IS3_triax_lAP1_tri_elem_num-1].element_set = 'is3tlap1_tri'
...
g.list_of_elements[TEr_foam_u2_tri_elem_num-1].element_set  = 'tefoamu2_tri'
g.list_of_elements[TEr_foam_l2_tri_elem_num-1].element_set  = 'tefoaml2_tri'
g.list_of_elements[TEr_foam_u3_tri_elem_num-1].element_set  = 'tefoamu3_tri'
g.list_of_elements[TEr_foam_l3_tri_elem_num-1].element_set  = 'tefoaml3_tri'
...
g.list_of_elements[IS3_triax_uAP1_tri_elem_num-1].plot()
g.list_of_elements[IS3_triax_lAP1_tri_elem_num-1].plot()
...
g.list_of_elements[TEr_foam_u2_tri_elem_num-1].plot() 
g.list_of_elements[TEr_foam_u2_tri_elem_num-2].plot() 
g.list_of_elements[TEr_foam_l2_tri_elem_num-1].plot() 
g.list_of_elements[TEr_foam_l2_tri_elem_num-2].plot() 

g.list_of_elements[TEr_foam_u3_tri_elem_num-1].plot() 
g.list_of_elements[TEr_foam_u3_tri_elem_num-2].plot() 
g.list_of_elements[TEr_foam_l3_tri_elem_num-1].plot() 
g.list_of_elements[TEr_foam_l3_tri_elem_num-2].plot() 
