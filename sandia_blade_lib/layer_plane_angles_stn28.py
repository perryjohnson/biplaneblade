...
IS3_triax_u1_tri_elem_num = 3052  # num of tri elem in IS3 triax upper 1
IS3_triax_l1_tri_elem_num = 2998  # num of tri elem in IS3 triax lower 1
IS3_resin_u2_tri_elem_num = 2809  # num of tri elem in IS3 resin upper 2
IS3_resin_l2_tri_elem_num = 2759  # num of tri elem in IS3 resin lower 2
IS3_triax_u2_tri_elem_num = 3058  # num of tri elem in IS3 triax upper 2
IS3_triax_l2_tri_elem_num = 3004  # num of tri elem in IS3 triax lower 2
TEr_foam_u3_tri_elem_num  = 3329  # num of tri elem in TE reinf foam upper 3
TEr_foam_l3_tri_elem_num  = 3264  # num of tri elem in TE reinf foam lower 3
TEr_uniax_u3_tri_elem_num = 3469  # num of tri elem in TE reinf uniax upper 3
TEr_uniax_l3_tri_elem_num = 3399  # num of tri elem in TE reinf uniax lower 3
# -----------------------------------------------
...
g.list_of_elements[IS3_triax_u1_tri_elem_num-1].plot()
g.list_of_elements[IS3_triax_l1_tri_elem_num-1].plot()
