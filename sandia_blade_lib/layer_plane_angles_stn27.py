...
IS3_triax_u2_tri_elem_num = 3056  # num of tri elem in IS3 triax upper 2
IS3_triax_l2_tri_elem_num = 3003  # num of tri elem in IS3 triax lower 2
TEr_foam_u3_tri_elem_num  = 3327  # num of tri elem in TE reinf foam upper 3
TEr_foam_l3_tri_elem_num  = 3262  # num of tri elem in TE reinf foam lower 3
TEr_uniax_u3_tri_elem_num = 3469  # num of tri elem in TE reinf uniax upper 3
TEr_uniax_l3_tri_elem_num = 3398  # num of tri elem in TE reinf uniax lower 3
# -----------------------------------------------
