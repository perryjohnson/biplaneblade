...
IS3_resin_u2_tri_elem_num = 2729  # num of tri elem in IS3 resin upper 2
IS3_resin_l2_tri_elem_num = 2647  # num of tri elem in IS3 resin lower 2
IS3_triax_u2_tri_elem_num = 2916  # num of tri elem in IS3 triax upper 2
IS3_triax_l2_tri_elem_num = 2831  # num of tri elem in IS3 triax lower 2
TEr_foam_u3_tri_elem_num = 643  # num of tri elem in TE reinf foam upper 3
TEr_foam_l3_tri_elem_num = 550  # num of tri elem in TE reinf foam lower 3
TEr_uniax_u3_tri_elem_num = 843  # num of tri elem in TE reinf uniax upper 3
TEr_uniax_l3_tri_elem_num = 743  # num of tri elem in TE reinf uniax lower 3
# -----------------------------------------------
