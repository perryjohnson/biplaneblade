...
IS4_resin_u2_tri_elem_num = 4036  # num of tri elem in IS4 resin upper 2
IS4_resin_l2_tri_elem_num = 3986  # num of tri elem in IS4 resin lower 2
IS4_triax_u2_tri_elem_num = 4239  # num of tri elem in IS4 triax upper 2
IS4_triax_l2_tri_elem_num = 4186  # num of tri elem in IS4 triax lower 2
# -----------------------------------------------
...
g.list_of_elements[4517-1].plot()
g.list_of_elements[4518-1].plot()
g.list_of_elements[4579-1].plot()
g.list_of_elements[4580-1].plot()
