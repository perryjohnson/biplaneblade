...
IS3_resin_u2_tri_elem_num = 2393  # num of tri elem in IS3 resin upper 2
IS3_resin_l2_tri_elem_num = 2311  # num of tri elem in IS3 resin lower 2
IS3_triax_u2_tri_elem_num = 2860  # num of tri elem in IS3 triax upper 2
IS3_triax_l2_tri_elem_num = 2775  # num of tri elem in IS3 triax lower 2
...
TEr_uniax_u3_tri_elem_num = 1160  # num of tri elem in TE reinf uniax upper 3
TEr_uniax_l3_tri_elem_num = 1061  # num of tri elem in TE reinf uniax lower 3
# -----------------------------------------------
