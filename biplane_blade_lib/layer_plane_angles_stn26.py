...
IS4_resin_u2_tri_elem_num = 4648  # num of tri elem in int surf 3 resin upper 2
IS4_resin_l2_tri_elem_num = 4627  # num of tri elem in int surf 3 resin lower 2
IS4_triax_u2_tri_elem_num = 4801  # num of tri elem in int surf 3 triax upper 2
IS4_triax_l2_tri_elem_num = 4778  # num of tri elem in int surf 3 triax lower 2
TE_reinf_foam_u3_tri_elem_num = 4964  # num of tri elem in TE reinf foam upper 3
TE_reinf_foam_l3_tri_elem_num = 4936  # num of tri elem in TE reinf foam lower 3
# -----------------------------------------------
