...
IS3_resin_u2_tri_elem_num = 3578  # num of tri elem in int surf 3 resin upper 2
IS3_resin_l2_tri_elem_num = 3553  # num of tri elem in int surf 3 resin lower 2
TE_reinf_foam_u3_tri_elem_num = 4062  # num of tri elem in TE reinf foam upper 3
TE_reinf_foam_l3_tri_elem_num = 4022  # num of tri elem in TE reinf foam lower 3
# -----------------------------------------------
