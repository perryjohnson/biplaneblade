...
IS4_resin_u2_tri_elem_num = 3148  # num of tri elem in int surf 3 resin upper 2
IS4_resin_l2_tri_elem_num = 3131  # num of tri elem in int surf 3 resin lower 2
TE_reinf_foam_u3_tri_elem_num = [637,622]  # num of tri elem in TE reinf foam upper 3
TE_reinf_foam_l3_tri_elem_num = [573,558]  # num of tri elem in TE reinf foam lower 3
# -----------------------------------------------
