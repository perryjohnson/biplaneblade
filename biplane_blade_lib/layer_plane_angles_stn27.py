...
IS4_resin_u2_tri_elem_num = 4644  # num of tri elem in int surf 3 resin upper 2
IS4_resin_l2_tri_elem_num = 4623  # num of tri elem in int surf 3 resin lower 2
IS4_triax_u2_tri_elem_num = 4797  # num of tri elem in int surf 3 triax upper 2
IS4_triax_l2_tri_elem_num = 4774  # num of tri elem in int surf 3 triax lower 2
TE_reinf_foam_u3_tri_elem_num = 4960  # num of tri elem in TE reinf foam upper 3
TE_reinf_foam_l3_tri_elem_num = 4932  # num of tri elem in TE reinf foam lower 3
# -----------------------------------------------
