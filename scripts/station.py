...
class BiplaneStation(Station):
    ...
    def __init__(self, stn_series, blade_path):
        ...
        self.logf.flush()
        self.logf.close()
        # check to see if 'airfoil upper' is NaN, if not, overwrite self.airfoil with a BiplaneAirfoil...and go from there?!
